...
// Complete BHA rental data extracted from the 6 screenshots
const bhaRentalData = {
  "02351": { // Abington
...
bhaData.metadata.note = "Updated with specific BHA rental data from seed file - no longer using market tiers";

// Write the updated data back to the file
fs.writeFileSync(bhaFilePath, JSON.stringify(bhaData, null, 2));

console.log(`\nUpdated ${updatedCount} zip codes with BHA rental data from seed file`);
console.log(`Total zip codes in seed data: ${Object.keys(bhaRentalData).length}`);
